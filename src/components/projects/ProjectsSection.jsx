          ...
          >
            <defs>
              <style>{`
                ...
                .bm3{stroke-dasharray:20 20;animation:bs-march  5s linear infinite}
            ...
            <g fill="none" stroke="#a8c060" strokeWidth="0.8">
              <polygon points="60,120 72,108 84,120 72,132" className="bp1" />
              <polygon points="200,50 210,40 220,50 210,60" className="bp2" />
              <polygon
                points="340,120 354,106 368,120 354,134"
                className="bp3"
              />
              <polygon points="480,50 490,40 500,50 490,60" className="bp1" />
              <polygon
            ...
            {/* corner rosettes */}
            <g fill="none" stroke="#a8c060" strokeWidth="0.7" className="bp2">
            ...
            <g fill="none" stroke="#d4a843" strokeWidth="0.7" className="bp3">
